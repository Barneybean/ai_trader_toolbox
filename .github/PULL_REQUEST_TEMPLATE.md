...
- [ ] 📚 Sector playbook — the flagship contribution, thank you!
...
- [ ] **Playbooks:** follows `skills/analysis/sectors/_TEMPLATE.md` (all seven fields) and is registered in `skills/analysis/sector-playbooks.md` + `skills/analysis/sectors/README.md`
- [ ] **Playbooks:** meets the quality bar — specific · falsifiable · primary-sourced · dated · illustrated · general (see `CONTRIBUTING.md`)
