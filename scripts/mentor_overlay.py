...
If your investing is mentor-influenced, the highest-signal risk check is relative:
where do you hold MORE of something the mentor is exiting, or NOTHING of a wing the
mentor sizes seriously? A large relative overweight in a name the mentor's sheet says
SELL is exactly the kind of drift nobody notices until it hurts.

    python3 scripts/mentor_overlay.py positions.json [--mentor journal/mentor-book.json]
