...
Usage:
  ...
  python3 scripts/reverse_dcf.py --mcap 390e9 --fcf 11e9
  python3 scripts/reverse_dcf.py --price 140.27 --shares 2.8e9 --fcf 11e9 --discount 0.10

  # three-scenario fair value (growth for N years, then exit multiple on FCF)
  python3 scripts/reverse_dcf.py --fcf 11e9 --shares 2.8e9 --scenarios 0.20:25 0.12:18 0.05:12
