...
# Run once (and it's safe to re-run): bash scripts/ops/install_mirrors.sh
set -euo pipefail
...
echo
echo "Claude Desktop: run 'python3 scripts/ops/package_skill.py' then upload dist/ai-trader.zip"
