...
from indicators import (  # noqa: E402
    _find_bars, _ohlcv, ema_series, atr, bollinger, obv_series,
)
...
def squeeze_coil(highs, lows, closes, volumes, atr_val):
    ...
    squeeze_on = bb["upper"] - bb["lower"] < kc[1] / 100 * kc[0]
...
def build(bars, price_override=None, float_shares=None, options=None):
    ...
    if flow_pressure is not None:
        agree = result["signals_agree"]
        notes.append(f"flow pressure {flow_pressure:+.0f}/100 ({conf} confidence"
