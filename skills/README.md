...
- `decision/strategies.md` — exit discipline, rank-and-rotate, validation patterns, and the optional rolling-position audit (`../scripts/analysis/position_manager.py`) that benchmarks supplied ledgers and risk-caps staged adds without creating signals or orders.
