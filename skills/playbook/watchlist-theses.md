...
For each tracked name:
- **Thesis (1–2 lines):** the variant view — what you see that the market doesn't.
- **Sleeve:** Tactical (swing/catalyst) or Core (position/valuation).
- **Trigger:** the level or event you're waiting for.
- **Invalidation:** the price *and* a non-price condition that says the thesis is wrong.

## Example rows (replace)

| Ticker | Sleeve | Thesis (variant view) | Trigger (wait for) | Invalidation |
|--------|--------|-----------------------|--------------------|--------------|
